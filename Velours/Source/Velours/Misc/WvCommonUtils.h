 ...
 */
UCLASS()
class VELOURS_API UWvCommonUtils : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	static FHitReactInfoRow* FindHitReactInfoRow(ABasePawn* Character);
	...
	static FHitResult CapsuleHasRoomCheck(ABasePawn* Character, const FVector TargetLocation, const float HeightOffset, const float RadiusOffset);
};
