...
FHitReactInfoRow* UWvCommonUtils::FindHitReactInfoRow(ABasePawn* Character)
{
...
FHitResult UWvCommonUtils::CapsuleHasRoomCheck(ABasePawn* Character, const FVector TargetLocation, const float HeightOffset, const float RadiusOffset)
{
