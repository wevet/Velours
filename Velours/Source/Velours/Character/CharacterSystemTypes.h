...
USTRUCT(BlueprintType)
struct VELOURS_API FLocomotionEssencialVariables
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct VELOURS_API FSwimmingTraceSettings
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct VELOURS_API FSwimmingTraceInfo
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct VELOURS_API FSwimmingControlInfo
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct VELOURS_API FSwimSettings
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct VELOURS_API FClimbingLedge
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct VELOURS_API FVelocityBlend
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct VELOURS_API FInteractionIKEffector
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct VELOURS_API FClimbingIKData
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct VELOURS_API FClimbingJumpInfo
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct VELOURS_API FDynamicMontageParams
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct VELOURS_API FJumpProjection
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct VELOURS_API FClimbingCurveData
{
...
USTRUCT(BlueprintType)
struct VELOURS_API FCharacterWeaknessData
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct VELOURS_API FCharacterWeaknessContainer
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct VELOURS_API FWeaponCharacterAnimationInput
{
	GENERATED_BODY()
