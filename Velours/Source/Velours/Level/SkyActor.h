...
UCLASS()
class VELOURS_API ASkyActor : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "SkyActor|Config")
	bool bIsForceStopPostProcessEffect{false};
};
