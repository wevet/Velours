...
class VELOURS_API UItemInventoryDataAsset : public UDataAsset
{
	GENERATED_BODY()
...
class VELOURS_API UInventoryComponent : public UActorComponent, public IAsyncComponentInterface
{
	GENERATED_BODY()
