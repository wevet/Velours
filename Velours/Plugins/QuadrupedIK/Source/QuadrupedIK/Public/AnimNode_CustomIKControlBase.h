...
struct QUADRUPEDIK_API FAnimNode_CustomIKControlBase : public FAnimNode_Base
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Alpha, meta = (PinHiddenByDefault))
...
protected:
	...
	virtual FVector GetCurrentLocation(FCSPose<FCompactPose>& MeshBases, const FCompactPoseBoneIndex& BoneIndex) const;
