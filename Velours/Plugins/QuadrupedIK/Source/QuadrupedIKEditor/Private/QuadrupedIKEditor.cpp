...
void FQuadrupedIKEditorModule::StartupModule()
{
	...
	FEditorModeRegistry::Get().RegisterMode<FCustomAimSolverEditMode>(FAimSolverEditModes::CustomAimSolver, LOCTEXT("CustomAimSolverEditMode", "CustomAimSolver"), FSlateIcon(), false);
}
